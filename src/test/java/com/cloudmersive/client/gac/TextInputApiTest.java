...
public class TextInputApiTest {
    ...
    public void textInputCheckHtmlSsrfTest()  {
        String value = null;
        HtmlSsrfDetectionResult response = api.textInputCheckHtmlSsrf(value).block();
    ...
    public void textInputCheckSqlInjectionTest()  {
        ...
        SqlInjectionDetectionResult response = api.textInputCheckSqlInjection(value, detectionLevel).block();
    ...
    public void textInputCheckSqlInjectionBatchTest()  {
        ...
        SqlInjectionCheckBatchResponse response = api.textInputCheckSqlInjectionBatch(value).block();
    ...
    public void textInputCheckXssTest()  {
        String value = null;
        XssProtectionResult response = api.textInputCheckXss(value).block();
    ...
    public void textInputCheckXssBatchTest()  {
        ...
        XssProtectionBatchResponse response = api.textInputCheckXssBatch(value).block();
    ...
    public void textInputCheckXxeTest()  {
        ...
        XxeDetectionResult response = api.textInputCheckXxe(value, allowInternetUrls, knownSafeUrls, knownUnsafeUrls).block();
    ...
    public void textInputCheckXxeBatchTest()  {
        ...
        XxeDetectionBatchResponse response = api.textInputCheckXxeBatch(request).block();
    ...
    public void textInputProtectXssTest()  {
        String value = null;
        XssProtectionResult response = api.textInputProtectXss(value).block();
