...
public class LanguageTranslationApiTest {
    ...
    public void languageTranslationTranslateDeuToEngTest()  {
        ...
        LanguageTranslationResponse response = api.languageTranslationTranslateDeuToEng(input).block();
    ...
    public void languageTranslationTranslateEngToDeuTest()  {
        LanguageTranslationRequest input = null;
        LanguageTranslationResponse response = api.languageTranslationTranslateEngToDeu(input).block();
    ...
    public void languageTranslationTranslateEngToFraTest()  {
        LanguageTranslationRequest input = null;
        LanguageTranslationResponse response = api.languageTranslationTranslateEngToFra(input).block();
    ...
    public void languageTranslationTranslateEngToRusTest()  {
        LanguageTranslationRequest input = null;
        LanguageTranslationResponse response = api.languageTranslationTranslateEngToRus(input).block();
    ...
    public void languageTranslationTranslateFraToEngTest()  {
        LanguageTranslationRequest input = null;
        LanguageTranslationResponse response = api.languageTranslationTranslateFraToEng(input).block();
    ...
    public void languageTranslationTranslateRusToEngTest()  {
        LanguageTranslationRequest input = null;
        LanguageTranslationResponse response = api.languageTranslationTranslateRusToEng(input).block();
