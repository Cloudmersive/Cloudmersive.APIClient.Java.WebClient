...
public class PosTaggerApiTest {
    ...
    public void posTaggerTagAdjectivesTest()  {
        ...
        PosResponse response = api.posTaggerTagAdjectives(request).block();
    ...
    public void posTaggerTagAdverbsTest()  {
        PosRequest request = null;
        PosResponse response = api.posTaggerTagAdverbs(request).block();
    ...
    public void posTaggerTagNounsTest()  {
        PosRequest request = null;
        PosResponse response = api.posTaggerTagNouns(request).block();
    ...
    public void posTaggerTagPronounsTest()  {
        PosRequest request = null;
        PosResponse response = api.posTaggerTagPronouns(request).block();
    ...
    public void posTaggerTagSentenceTest()  {
        PosRequest request = null;
        PosResponse response = api.posTaggerTagSentence(request).block();
    ...
    public void posTaggerTagVerbsTest()  {
        PosRequest request = null;
        PosResponse response = api.posTaggerTagVerbs(request).block();
