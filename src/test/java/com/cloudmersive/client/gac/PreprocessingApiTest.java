...
public class PreprocessingApiTest {
    ...
    public void preprocessingBinarizeTest()  {
        ...
        byte[] response = api.preprocessingBinarize(imageFile).block();
    ...
    public void preprocessingBinarizeAdvancedTest()  {
        org.springframework.core.io.AbstractResource imageFile = null;
        byte[] response = api.preprocessingBinarizeAdvanced(imageFile).block();
    ...
    public void preprocessingGetPageAngleTest()  {
        org.springframework.core.io.AbstractResource imageFile = null;
        GetPageAngleResult response = api.preprocessingGetPageAngle(imageFile).block();
    ...
    public void preprocessingUnrotateTest()  {
        org.springframework.core.io.AbstractResource imageFile = null;
        byte[] response = api.preprocessingUnrotate(imageFile).block();
    ...
    public void preprocessingUnrotateAdvancedTest()  {
        org.springframework.core.io.AbstractResource imageFile = null;
        byte[] response = api.preprocessingUnrotateAdvanced(imageFile).block();
    ...
    public void preprocessingUnskewTest()  {
        org.springframework.core.io.AbstractResource imageFile = null;
        byte[] response = api.preprocessingUnskew(imageFile).block();
