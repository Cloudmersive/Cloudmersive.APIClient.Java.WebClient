...
public class VideoApiTest {
    ...
    public void videoConvertToGifTest()  {
        ...
        byte[] response = api.videoConvertToGif(fileUrl, maxWidth, maxHeight, preserveAspectRatio, frameRate, startTime, timeSpan, inputFile).block();
    ...
    public void videoConvertToMovTest()  {
        ...
        org.springframework.core.io.AbstractResource inputFile = null;
        byte[] response = api.videoConvertToMov(fileUrl, maxWidth, maxHeight, preserveAspectRatio, frameRate, quality, inputFile).block();
    ...
    public void videoConvertToMp4Test()  {
        ...
        Integer quality = null;
        org.springframework.core.io.AbstractResource inputFile = null;
        byte[] response = api.videoConvertToMp4(fileUrl, maxWidth, maxHeight, preserveAspectRatio, frameRate, quality, inputFile).block();
    ...
    public void videoConvertToStillFramesTest()  {
        ...
        org.springframework.core.io.AbstractResource inputFile = null;
        StillFramesResult response = api.videoConvertToStillFrames(fileUrl, maxWidth, maxHeight, framesPerSecond, inputFile).block();
    ...
    public void videoConvertToWebmTest()  {
        ...
        Integer quality = null;
        org.springframework.core.io.AbstractResource inputFile = null;
        byte[] response = api.videoConvertToWebm(fileUrl, maxWidth, maxHeight, preserveAspectRatio, frameRate, quality, inputFile).block();
    ...
    public void videoCutVideoTest()  {
        ...
        OffsetDateTime timeSpan = null;
        org.springframework.core.io.AbstractResource inputFile = null;
        byte[] response = api.videoCutVideo(fileUrl, startTime, timeSpan, inputFile).block();
    ...
    public void videoGetInfoTest()  {
        String fileUrl = null;
        org.springframework.core.io.AbstractResource inputFile = null;
        MediaInformation response = api.videoGetInfo(fileUrl, inputFile).block();
    ...
    public void videoResizeVideoTest()  {
        ...
        org.springframework.core.io.AbstractResource inputFile = null;
        byte[] response = api.videoResizeVideo(fileUrl, maxWidth, maxHeight, frameRate, quality, extension, inputFile).block();
    ...
    public void videoResizeVideoSimpleTest()  {
        ...
        String extension = null;
        org.springframework.core.io.AbstractResource inputFile = null;
        byte[] response = api.videoResizeVideoSimple(fileUrl, maxWidth, maxHeight, frameRate, quality, extension, inputFile).block();
    ...
    public void videoScanForNsfwTest()  {
        ...
        BigDecimal framesPerSecond = null;
        org.springframework.core.io.AbstractResource inputFile = null;
        NsfwResult response = api.videoScanForNsfw(fileUrl, framesPerSecond, inputFile).block();
    ...
    public void videoSplitVideoTest()  {
        ...
        OffsetDateTime timeSpan = null;
        org.springframework.core.io.AbstractResource inputFile = null;
        SplitVideoResult response = api.videoSplitVideo(splitTime, fileUrl, timeSpan, inputFile).block();
