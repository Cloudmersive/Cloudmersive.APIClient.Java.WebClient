...
public class ImageOcrApiTest {
    ...
    public void imageOcrImageLinesWithLocationTest()  {
        ...
        ImageToLinesWithLocationResult response = api.imageOcrImageLinesWithLocation(imageFile, language, preprocessing).block();
    ...
    public void imageOcrImageWordsWithLocationTest()  {
        ...
        String language = null;
        String preprocessing = null;
        ImageToWordsWithLocationResult response = api.imageOcrImageWordsWithLocation(imageFile, language, preprocessing).block();
    ...
    public void imageOcrPhotoRecognizeBusinessCardTest()  {
        org.springframework.core.io.AbstractResource imageFile = null;
        BusinessCardRecognitionResult response = api.imageOcrPhotoRecognizeBusinessCard(imageFile).block();
    ...
    public void imageOcrPhotoRecognizeFormTest()  {
        ...
        String language = null;
        FormRecognitionResult response = api.imageOcrPhotoRecognizeForm(imageFile, formTemplateDefinition, recognitionMode, preprocessing, diagnostics, language).block();
    ...
    public void imageOcrPhotoRecognizeFormAdvancedTest()  {
        ...
        String preprocessing = null;
        String diagnostics = null;
        FormRecognitionResult response = api.imageOcrPhotoRecognizeFormAdvanced(imageFile, bucketID, bucketSecretKey, recognitionMode, preprocessing, diagnostics).block();
    ...
    public void imageOcrPhotoRecognizeReceiptTest()  {
        ...
        String language = null;
        String preprocessing = null;
        ReceiptRecognitionResult response = api.imageOcrPhotoRecognizeReceipt(imageFile, recognitionMode, language, preprocessing).block();
    ...
    public void imageOcrPhotoToTextTest()  {
        ...
        String recognitionMode = null;
        String language = null;
        ImageToTextResponse response = api.imageOcrPhotoToText(imageFile, recognitionMode, language).block();
    ...
    public void imageOcrPhotoWordsWithLocationTest()  {
        ...
        String preprocessing = null;
        String diagnostics = null;
        PhotoToWordsWithLocationResult response = api.imageOcrPhotoWordsWithLocation(imageFile, recognitionMode, language, preprocessing, diagnostics).block();
    ...
    public void imageOcrPostTest()  {
        ...
        String language = null;
        String preprocessing = null;
        ImageToTextResponse response = api.imageOcrPost(imageFile, recognitionMode, language, preprocessing).block();
