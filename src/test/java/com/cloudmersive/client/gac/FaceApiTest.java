...
public class FaceApiTest {
    ...
    public void faceCompareTest()  {
        ...
        org.springframework.core.io.AbstractResource matchFace = null;
        FaceCompareResponse response = api.faceCompare(inputImage, matchFace).block();
    ...
    public void faceCropFirstTest()  {
        ...
        byte[] response = api.faceCropFirst(imageFile).block();
    ...
    public void faceCropFirstRoundTest()  {
        org.springframework.core.io.AbstractResource imageFile = null;
        byte[] response = api.faceCropFirstRound(imageFile).block();
    ...
    public void faceDetectAgeTest()  {
        org.springframework.core.io.AbstractResource imageFile = null;
        AgeDetectionResult response = api.faceDetectAge(imageFile).block();
    ...
    public void faceDetectGenderTest()  {
        org.springframework.core.io.AbstractResource imageFile = null;
        GenderDetectionResult response = api.faceDetectGender(imageFile).block();
    ...
    public void faceLocateTest()  {
        org.springframework.core.io.AbstractResource imageFile = null;
        FaceLocateResponse response = api.faceLocate(imageFile).block();
    ...
    public void faceLocateWithLandmarksTest()  {
        org.springframework.core.io.AbstractResource imageFile = null;
        FaceLocateWithLandmarksResponse response = api.faceLocateWithLandmarks(imageFile).block();
