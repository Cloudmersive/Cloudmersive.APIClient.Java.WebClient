...
public class AnalyticsApiTest {
    ...
    public void analyticsHateSpeechTest()  {
        ...
        HateSpeechAnalysisResponse response = api.analyticsHateSpeech(input).block();
    ...
    public void analyticsProfanityTest()  {
        ...
        ProfanityAnalysisResponse response = api.analyticsProfanity(input).block();
    ...
    public void analyticsSentimentTest()  {
        ...
        SentimentAnalysisResponse response = api.analyticsSentiment(input).block();
    ...
    public void analyticsSimilarityTest()  {
        ...
        SimilarityAnalysisResponse response = api.analyticsSimilarity(input).block();
    ...
    public void analyticsSubjectivityTest()  {
        ...
        SubjectivityAnalysisResponse response = api.analyticsSubjectivity(input).block();
