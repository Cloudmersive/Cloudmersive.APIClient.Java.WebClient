...
public class ScanCloudStorageApiTest {
    ...
    public void scanCloudStorageScanAwsS3FileTest()  {
        ...
        String keyName = null;
        CloudStorageVirusScanResult response = api.scanCloudStorageScanAwsS3File(accessKey, secretKey, bucketRegion, bucketName, keyName).block();
    ...
    public void scanCloudStorageScanAzureBlobTest()  {
        ...
        CloudStorageVirusScanResult response = api.scanCloudStorageScanAzureBlob(connectionString, containerName, blobPath).block();
    ...
    public void scanCloudStorageScanGcpStorageFileTest()  {
        ...
        org.springframework.core.io.AbstractResource jsonCredentialFile = null;
        CloudStorageVirusScanResult response = api.scanCloudStorageScanGcpStorageFile(bucketName, objectName, jsonCredentialFile).block();
    ...
    public void scanCloudStorageScanSharePointOnlineFileTest()  {
        ...
        String itemID = null;
        CloudStorageVirusScanResult response = api.scanCloudStorageScanSharePointOnlineFile(clientID, clientSecret, sharepointDomainName, siteID, filePath, tenantID, itemID).block();
