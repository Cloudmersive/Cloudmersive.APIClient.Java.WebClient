...
public class ScanApiTest {
    ...
    public void scanFileTest()  {
        ...
        VirusScanResult response = api.scanFile(inputFile).block();
    ...
    public void scanFileAdvancedTest()  {
        ...
        VirusScanAdvancedResult response = api.scanFileAdvanced(inputFile, allowExecutables, allowInvalidFiles, allowScripts, allowPasswordProtectedFiles, allowMacros, allowXmlExternalEntities, allowInsecureDeserialization, allowHtml, restrictFileTypes).block();
    ...
    public void scanWebsiteTest()  {
        ...
        WebsiteScanResult response = api.scanWebsite(input).block();
